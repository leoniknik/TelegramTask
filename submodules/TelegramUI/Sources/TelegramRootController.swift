...
public final class TelegramRootController: NavigationController {
    ...
    public func addRootControllers(showCallsTab: Bool) {
        ...
        let accountSettingsController = PeerInfoScreenImpl(context: self.context, titleData: (0, signal: Signal.never()), updatedPresentationData: nil, peerId: self.context.account.peerId, avatarInitiallyExpanded: false, isOpenedFromChat: false, nearbyPeerDistance: nil, callMessages: [], isSettings: true)
